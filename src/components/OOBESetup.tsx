...
export const OOBESetup: React.FC<OOBESetupProps> = ({ initialSettings, onComplete }) => {
  ...
  return (
    ...
    >
      ...
      {/* Main OOBE Screen Canvas */}
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-8 flex flex-col justify-center items-center text-center">
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="w-full max-w-md bg-[#003866] border border-white/30 h-56 overflow-y-auto text-left shadow-inner custom-scrollbar">
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="w-full max-w-lg space-y-5 text-left">
                  ...
                  <div className="bg-[#003866] border border-white/30">
                    {[
                      ...
                      <div
                        ...
                        className={`p-3 text-xs cursor-pointer border-b border-white/10 flex flex-col gap-0.5 ${
                ...
                {/* Auto save checkbox */}
                <label className="flex items-center gap-3 p-3 bg-[#003866] border border-white/30 cursor-pointer">
                  <input
                    type="checkbox"
      ...
      {/* Action Area: Bottom Right Next / "はい" Button */}
      <div className="w-full max-w-4xl mx-auto px-6 pb-6 flex items-center justify-between">
        <div>
          {step > 1 && (
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-1.5 bg-[#003866] hover:bg-[#004e8a] border border-white/30 text-white text-xs cursor-pointer transition-colors"
            >
              いいえ / 戻る
            </button>
          )}
        ...
        <div>
          <button
            type="button"
            onClick={handleNext}
            className="px-10 py-2 bg-[#0078d7] hover:bg-[#0063b1] active:bg-[#005a9e] text-white text-sm font-normal border border-white/20 cursor-pointer shadow-xs transition-colors"
          >
            {step === totalSteps ? 'はい (デスクトップへ)' : 'はい'}
          </button>
        </div>
      </div>
